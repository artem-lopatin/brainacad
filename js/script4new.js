...
if(shareholderCount>0){
    ...
    var protShareholder = document.getElementById('protShareholder');

    for(var j=1;j<=shareholderCount;j++) {
        var newProtShareholder=protShareholder.cloneNode(true);
        [].forEach.call(newProtShareholder.querySelectorAll('span'), function (el, i) {
            el.className = protShareholder.querySelectorAll('span')[i].className + j;
        });

        document.getElementById('protShareholders').appendChild(newProtShareholder);
    }
    ...
    var statShareholder = document.getElementById('statShareholder');

    for(var j=1;j<=shareholderCount;j++) {
        var newStatShareholder=statShareholder.cloneNode(true);
        [].forEach.call(newStatShareholder.querySelectorAll('span'), function (el, i) {
            el.className = statShareholder.querySelectorAll('span')[i].className + j;
        });

        document.getElementById('statShareholders').appendChild(newStatShareholder);
    }
